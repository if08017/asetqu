    ...
    <div class="col-sm-10 content2">
      ...
      <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control datepicker" id="text" name="created_year" placeholder="Tahun pembuatan">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-4" for="name">Tahun Pembelian</label>
          <div class="col-sm-8">
            <input type="text" class="form-control datepicker" id="text" name="buy_year" placeholder="Tahun pembelian">
          </div>
        </div>
      </div>
      </form>
