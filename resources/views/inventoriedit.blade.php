      ...
      <form class="form-horizontal" action="/inventori/{{$inventori->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="text" name="name" value="{{ $inventori->name }}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-8">
              <select class="from-control" id="sel1" name="satuan" required>
                <option value="{{ $inventori->satuan_name }}">{{ $inventori->satuan_name }}</option>
                <optgroup label="---">
